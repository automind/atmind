...
/*
 * Regula: An annotation-based form-validation framework in Javascript Version
 * 1.2.4-SNAPSHOT
 * 
 * Written By Vivin Paliath (http://vivin.net) License: BSD License
 * 
 * TODO: Add step validation to regula (like html5 step validation) TODO: Add
 * URL validation to regula (like html5 url validation) Copyright (C) 2010-2012
 */
