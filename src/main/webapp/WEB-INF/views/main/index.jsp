    ...
    <section id="about" class="about-section">
         <div class="row">
              ...
              <div class="col-md-6 col-sm-12 col-xs-12">
                <img class="img-responsive" src="/resources/images/bg/gallery-2.jpg" draggable="false" alt="">
              </div>
            ...
            <div class="portfolio-inner">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 mix apps">
                        <div class="item">
                            <a href="/resources/images/portfolio/1.jpg" class="portfolio-popup" title="Project Title">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 mix mockups">
                        <div class="item">
                            <a href="/resources/images/portfolio/2.jpg" class="portfolio-popup" title="Project Title">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 mix apps">
                        <div class="item">
                            <a href="/resources/images/portfolio/3.jpg" class="portfolio-popup" title="Project Title">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 mix mockups wordpress">
                        <div class="item">
                            <a href="/resources/images/portfolio/4.jpg" class="portfolio-popup" title="Project Title">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 mix wordpress apps">
                        <div class="item">
                            <a href="/resources/images/portfolio/5.jpg" class="portfolio-popup" title="Project Title">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 mix apps mockups wordpress" title="Project Title">
                        <div class="item">
                            <a href="/resources/images/portfolio/6.jpg" class="portfolio-popup">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="testimonial-carousel-list margin-top-20" >
                    ...
                    <img src="/resources/images/testimonial/1.png" class="img-responsive" alt="">
                        <h2>John doe</h2>
                    ...
                    <div class="testimonial-word text-center">
                    <img src="/resources/images/testimonial/2.png" class="img-responsive" alt="">
                        <h2>John doe</h2>
                        <p>quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duisauteiruredolor in reprehenderit in voluptate.</p>
                    </div>
                    
                    <div class="testimonial-word text-center">
                    <img src="/resources/images/testimonial/3.png" class="img-responsive" alt="">
                        <h2>John doe</h2>
                        <p>quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duisauteiruredolor in reprehenderit in voluptate.</p>
                    </div>
         ...
         <div class="container">     
           ...
           <div class="col-md-3 col-sm-6">
            <div class="statistics">
              <div class="statistics-icon"><i class="fa fa-battery-three-quarters color-7"></i>
              </div>
              <div class="statistics-content">
                <h5><span data-count="1325" class="statistics-count">1325</span>KM</h5><span>1회 충전으로</span>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-3 col-sm-6">
            <div class="statistics">
              <div class="statistics-icon"><i class="fa fa-tachometer color-1"></i>
              </div>
              <div class="statistics-content">
                <h5><span data-count="100" class="statistics-count">100</span>KM/h</h5><span>5초 이내 가속</span>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-3 col-sm-6">
            <div class="statistics">
              <div class="statistics-icon"><i class="fa fa-car color-5"></i>
              </div>
              <div class="statistics-content">
                <h5><span data-count="100" class="statistics-count">100</span>%</h5><span>완벽한 오토파일럿</span>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-3 col-sm-6">
            <div class="statistics">
              <div class="statistics-icon"><i class="fa fa-star color-3"></i>
              </div>
              <div class="statistics-content">
                <h5>별<span data-count="5" class="statistics-count">5</span>개</h5><span>안전등급 만점</span>
              </div>
            </div>
            </div>
